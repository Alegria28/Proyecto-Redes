...
; Configuramos zona para "local.pagina2.com"
...
@       IN      SOA     ns1.local.pagina2.com. admin.local.pagina2.com. ( ; Campos MNAME (master name server) y RNAME (responsible name)
                      3           ; Serial
                 604800           ; Refresh
                  86400           ; Retry
                2419200           ; Expire
...
@       IN      NS      ns1.local.pagina2.com.   
; Tipo de registro address el cual se encarga de mapear un nombre de host a una dirección IPv4 del contenedor de Apache (para local.pagina2.com)
@       IN      A       192.168.0.3               
; Tipo de registro address el cual se encarga de mapear un nombre de host a una dirección IPv4 del contenedor Bind9 (para ns1.local.pagina2.com)
