...
; Configuramos zona para "local.pagina1.com"
...
; Tipo de registro address el cual se encarga de mapear un nombre de host a una dirección IPv4 del contenedor de Apache (para local.pagina1.com)
@       IN      A       192.168.0.3               
; Tipo de registro address el cual se encarga de mapear un nombre de host a una dirección IPv4 del contenedor Bind9 (para ns1.local.pagina1.com)
