; Zona para local.pagina1.com

$TTL    604800
@       IN      SOA     ns1.local.pagina1.com. admin.local.pagina1.com. (
...
;
@       IN      NS      ns1.local.pagina1.com.   ; Servidor de nombres para esta zona
...
www     IN      A       172.18.0.5             ; Si quieres www.local.pagina1.com
admin   IN      A       1.1.1.1
app1    IN      A       2.2.2.2
api     IN      A       3.3.3.3  